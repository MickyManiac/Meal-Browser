...
async function handleTextQuery(evt) {
    ...
    if (validateText(textFieldElement.value)) // Geef de ingevulde zoekterm aan de functie die de zoekopdracht uitvoert.
...
async function fetchData(searchString) {
    ...
    try {
        ...
        const response = await _axiosDefault.default.get(`https://api.spoonacular.com/recipes/complexSearch?query=${searchString}&number=1&apiKey=ada1ef8535a14d7695ff0ba52516335a`);
